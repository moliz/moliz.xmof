 ...
 * <ul>
 *   <li>{@link org.modelexecution.xmof.states.states.impl.StateImpl#getOutgoing <em>Outgoing</em>}</li>
 *   <li>{@link org.modelexecution.xmof.states.states.impl.StateImpl#getIncoming <em>Incoming</em>}</li>
 *   <li>{@link org.modelexecution.xmof.states.states.impl.StateImpl#getObjects <em>Objects</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateImpl extends MinimalEObjectImpl.Container implements State {
		...
		if (outgoing != null && outgoing.eIsProxy()) {
			...
			if (outgoing != oldOutgoing) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StatesPackage.STATE__OUTGOING, oldOutgoing, outgoing));
			}
		}
		return outgoing;
	}
	...
	public NotificationChain basicSetOutgoing(Transition newOutgoing, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StatesPackage.STATE__OUTGOING, oldOutgoing, newOutgoing);
	...
	public void setOutgoing(Transition newOutgoing) {
		if (newOutgoing != outgoing) {
			...
			if (outgoing != null)
				msgs = ((InternalEObject)outgoing).eInverseRemove(this, StatesPackage.TRANSITION__SOURCE, Transition.class, msgs);
			if (newOutgoing != null)
				msgs = ((InternalEObject)newOutgoing).eInverseAdd(this, StatesPackage.TRANSITION__SOURCE, Transition.class, msgs);
			msgs = basicSetOutgoing(newOutgoing, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatesPackage.STATE__OUTGOING, newOutgoing, newOutgoing));
	}
	...
	public Transition getIncoming() {
		if (incoming != null && incoming.eIsProxy()) {
			...
			if (incoming != oldIncoming) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StatesPackage.STATE__INCOMING, oldIncoming, incoming));
			}
		}
		return incoming;
	}
	...
	public NotificationChain basicSetIncoming(Transition newIncoming, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StatesPackage.STATE__INCOMING, oldIncoming, newIncoming);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIncoming(Transition newIncoming) {
		if (newIncoming != incoming) {
			NotificationChain msgs = null;
			if (incoming != null)
				msgs = ((InternalEObject)incoming).eInverseRemove(this, StatesPackage.TRANSITION__TARGET, Transition.class, msgs);
			if (newIncoming != null)
				msgs = ((InternalEObject)newIncoming).eInverseAdd(this, StatesPackage.TRANSITION__TARGET, Transition.class, msgs);
			msgs = basicSetIncoming(newIncoming, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatesPackage.STATE__INCOMING, newIncoming, newIncoming));
	}
	...
	public EList<EObject> getObjects() {
		if (objects == null) {
			objects = new EObjectContainmentEList<EObject>(EObject.class, this, StatesPackage.STATE__OBJECTS);
		}
		return objects;
	}
