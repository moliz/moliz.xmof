...
/**
 * This is the item provider adapter for a {@link testlang.ActivityUnderTest} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TestlangPackage.Literals.ACTIVITY_UNDER_TEST__ACTIVITY,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TestlangPackage.Literals.ACTIVITY_UNDER_TEST__EXECUTE_UNTIL,
				 true,
				 false,
				 true,
				 null,
