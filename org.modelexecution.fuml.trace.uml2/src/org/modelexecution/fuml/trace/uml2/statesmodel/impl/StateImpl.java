 ...
 * <ul>
 *   <li>{@link org.modelexecution.fuml.trace.uml2.statesmodel.impl.StateImpl#getSnapshots <em>Snapshots</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateImpl extends MinimalEObjectImpl.Container implements State {
	/**
	 * The cached value of the '{@link #getSnapshots() <em>Snapshots</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getSnapshots()
	 * @generated
	...
	protected EClass eStaticClass() {
		return StatesmodelPackage.Literals.STATE;
	}
	...
	public EList<ValueSnapshot> getSnapshots() {
		if (snapshots == null) {
			snapshots = new EObjectResolvingEList<ValueSnapshot>(ValueSnapshot.class, this, StatesmodelPackage.STATE__SNAPSHOTS);
		}
		return snapshots;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StatesmodelPackage.STATE__SNAPSHOTS:
				return getSnapshots();
		}
