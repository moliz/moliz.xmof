 ...
 * <ul>
 *   <li>{@link org.modelexecution.fuml.trace.uml2.tracemodel.impl.ParameterSettingImpl#getParameter <em>Parameter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class ParameterSettingImpl extends MinimalEObjectImpl.Container implements ParameterSetting {
	/**
	 ...
	 * @generated
	 */
	protected ParameterSettingImpl() {
		super();
	}
		...
		if (parameter != null && parameter.eIsProxy()) {
			...
			if (parameter != oldParameter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TracemodelPackage.PARAMETER_SETTING__PARAMETER, oldParameter, parameter));
			}
		}
		return parameter;
	}
