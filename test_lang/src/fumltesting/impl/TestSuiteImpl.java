 ...
 * <ul>
 *   <li>{@link fumltesting.impl.TestSuiteImpl#getSystemUnderTest <em>System Under Test</em>}</li>
 *   <li>{@link fumltesting.impl.TestSuiteImpl#getTests <em>Tests</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TestSuiteImpl extends EObjectImpl implements TestSuite {
	...
	protected EClass eStaticClass() {
		return FumltestingPackage.Literals.TEST_SUITE;
	}
		...
		if (systemUnderTest != null && systemUnderTest.eIsProxy()) {
			...
			if (systemUnderTest != oldSystemUnderTest) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FumltestingPackage.TEST_SUITE__SYSTEM_UNDER_TEST, oldSystemUnderTest, systemUnderTest));
			}
		}
	...
	public void setSystemUnderTest(Model newSystemUnderTest) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FumltestingPackage.TEST_SUITE__SYSTEM_UNDER_TEST, oldSystemUnderTest, systemUnderTest));
	}
	...
	public EList<TestCase> getTests() {
		if (tests == null) {
			tests = new EObjectContainmentEList<TestCase>(TestCase.class, this, FumltestingPackage.TEST_SUITE__TESTS);
		}
		return tests;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FumltestingPackage.TEST_SUITE__TESTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FumltestingPackage.TEST_SUITE__SYSTEM_UNDER_TEST:
