...
public class OpaqueBehaviorFactory {
	...
	private OpaqueBehaviorExecution createListIndexOfBehavior() {
		...
		Parameter inputlist = createParameter("list",
				ParameterDirectionKind.in, 0, -1);
		Parameter inputindex = createParameter("object",
				ParameterDirectionKind.in, 1, 1);
		Parameter output = createParameter("result",
				ParameterDirectionKind.out, 1, 1);
	...
	private OpaqueBehaviorExecution createListgetBehavior() {
		...
		Parameter inputlist = createParameter("list",
				ParameterDirectionKind.in, 0, -1);
		Parameter inputindex = createParameter("index",
				ParameterDirectionKind.in, 1, 1);
		Parameter output = createParameter("result",
				ParameterDirectionKind.out, 1, 1);
		behavior.ownedParameter.add(inputlist);
	...
	private Parameter createParameter(String name,
			ParameterDirectionKind direction, int lowerBound, int upperBound) {
