 ...
 */
public class DirectedParameterItemProvider
	 ...
	 * @generated
	 */
	public DirectedParameterItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addDirectionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DirectedParameter_direction_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DirectedParameter_direction_feature", "_UI_DirectedParameter_type"),
				 KernelPackage.Literals.DIRECTED_PARAMETER__DIRECTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns DirectedParameter.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public Object getImage(Object object) {
		//return overlayImage(object, getResourceLocator().getImage("full/obj16/DirectedParameter"));
...
//		String label = ((DirectedParameter)object).getName();
//		return label == null || label.length() == 0 ?
//			getString("_UI_DirectedParameter_type") :
//			getString("_UI_DirectedParameter_type") + " " + label;
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DirectedParameter.class)) {
			case KernelPackage.DIRECTED_PARAMETER__NAME:
			case KernelPackage.DIRECTED_PARAMETER__ORDERED:
			case KernelPackage.DIRECTED_PARAMETER__UNIQUE:
			case KernelPackage.DIRECTED_PARAMETER__LOWER_BOUND:
			case KernelPackage.DIRECTED_PARAMETER__UPPER_BOUND:
			case KernelPackage.DIRECTED_PARAMETER__MANY:
			case KernelPackage.DIRECTED_PARAMETER__REQUIRED:
			case KernelPackage.DIRECTED_PARAMETER__DIRECTION:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case KernelPackage.DIRECTED_PARAMETER__EANNOTATIONS:
			case KernelPackage.DIRECTED_PARAMETER__EGENERIC_TYPE:
