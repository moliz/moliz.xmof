...
public class InstanceSpecificationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 KernelPackage.Literals.INSTANCE_SPECIFICATION__CLASSIFIER,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(KernelPackage.Literals.INSTANCE_SPECIFICATION__SLOT);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(InstanceSpecification.class)) {
			case KernelPackage.INSTANCE_SPECIFICATION__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case KernelPackage.INSTANCE_SPECIFICATION__EANNOTATIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(KernelPackage.Literals.INSTANCE_SPECIFICATION__SLOT,
				 KernelFactory.eINSTANCE.createSlot()));
	}
