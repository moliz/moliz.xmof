...
public class SlotItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 KernelPackage.Literals.SLOT__DEFINING_FEATURE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(KernelPackage.Literals.SLOT__VALUE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Slot.class)) {
			case KernelPackage.SLOT__EANNOTATIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(KernelPackage.Literals.SLOT__VALUE,
				 KernelFactory.eINSTANCE.createInstanceValue()));

		newChildDescriptors.add
			(createChildParameter
				(KernelPackage.Literals.SLOT__VALUE,
				 KernelFactory.eINSTANCE.createLiteralBoolean()));

		newChildDescriptors.add
			(createChildParameter
				(KernelPackage.Literals.SLOT__VALUE,
				 KernelFactory.eINSTANCE.createLiteralInteger()));

		newChildDescriptors.add
			(createChildParameter
				(KernelPackage.Literals.SLOT__VALUE,
				 KernelFactory.eINSTANCE.createLiteralNull()));

		newChildDescriptors.add
			(createChildParameter
				(KernelPackage.Literals.SLOT__VALUE,
				 KernelFactory.eINSTANCE.createLiteralString()));

		newChildDescriptors.add
			(createChildParameter
				(KernelPackage.Literals.SLOT__VALUE,
				 KernelFactory.eINSTANCE.createLiteralUnlimitedNatural()));
	}
