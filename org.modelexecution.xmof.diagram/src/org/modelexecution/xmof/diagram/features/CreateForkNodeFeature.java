...
public class CreateForkNodeFeature extends CreateControlNodeFeature {

	protected final static String CONTROL_NODE_TYPE_NAME = "Fork Node";
	...
	protected ControlNode createControlNode() {
		return IntermediateActivitiesFactory.eINSTANCE.createForkNode();
	}
