...
public class CreateReadSelfActionFeature extends CreateActionFeature {

	protected final static String ACTION_TYPE_NAME = "Read Self Action";

	public CreateReadSelfActionFeature(IFeatureProvider fp) {
