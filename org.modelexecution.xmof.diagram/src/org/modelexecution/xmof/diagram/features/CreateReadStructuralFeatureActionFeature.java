...
public class CreateReadStructuralFeatureActionFeature extends
		CreateActionFeature {

	protected final static String ACTION_TYPE_NAME = "Read Structural Feature Action";

	public CreateReadStructuralFeatureActionFeature(IFeatureProvider fp) {
