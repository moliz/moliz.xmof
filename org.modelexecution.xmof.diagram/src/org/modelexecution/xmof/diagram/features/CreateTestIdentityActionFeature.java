...
public class CreateTestIdentityActionFeature extends
		CreateActionFeature {

	protected final static String ACTION_TYPE_NAME = "Test Identity Action";

	public CreateTestIdentityActionFeature(IFeatureProvider fp) {
