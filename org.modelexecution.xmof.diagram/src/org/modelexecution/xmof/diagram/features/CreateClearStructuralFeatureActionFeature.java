...
public class CreateClearStructuralFeatureActionFeature extends
		CreateActionFeature {

	protected final static String ACTION_TYPE_NAME = "Clear Structural Feature Action";

	public CreateClearStructuralFeatureActionFeature(IFeatureProvider fp) {
