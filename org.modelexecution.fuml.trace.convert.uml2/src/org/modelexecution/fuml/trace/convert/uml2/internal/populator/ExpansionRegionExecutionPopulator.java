 ...
 *
 */
public class ExpansionRegionExecutionPopulator implements IUML2TraceElementPopulator {
	...
	public void populate(Object umlTraceElement, Object fumlTraceElement,
		...
		if(!(umlTraceElement instanceof ExpansionRegionExecution) || !(fumlTraceElement instanceof org.modelexecution.fumldebug.core.trace.tracemodel.ExpansionRegionExecution)) {
			return;
		}

		ExpansionRegionExecution umlExpansionRegionExecution = (ExpansionRegionExecution) umlTraceElement;
		org.modelexecution.fumldebug.core.trace.tracemodel.ExpansionRegionExecution fumlExpansionRegionExecution = (org.modelexecution.fumldebug.core.trace.tracemodel.ExpansionRegionExecution) fumlTraceElement;
		
		for(org.modelexecution.fumldebug.core.trace.tracemodel.ExpansionInput expansionInput : fumlExpansionRegionExecution.getExpansionInputs()) {
			umlExpansionRegionExecution.getExpansionInputs().add((ExpansionInput)result.getOutputUMLTraceElement(expansionInput));
		}
	}
