 ...
 *
 */
public class OutputValuePopulator implements IUML2TraceElementPopulator {
	...
	public void populate(Object umlTraceElement, Object fumlTraceElement,
		...
		if(!(umlTraceElement instanceof OutputValue) || !(fumlTraceElement instanceof org.modelexecution.fumldebug.core.trace.tracemodel.OutputValue)) {
			return;
		}

		OutputValue umlOutputValue = (OutputValue) umlTraceElement;
		org.modelexecution.fumldebug.core.trace.tracemodel.OutputValue fumlOutputValue = (org.modelexecution.fumldebug.core.trace.tracemodel.OutputValue) fumlTraceElement;
	
		umlOutputValue.setOutputObjectToken((ObjectTokenInstance)result.getOutputUMLTraceElement(fumlOutputValue.getOutputObjectToken()));
	}
