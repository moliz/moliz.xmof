 ...
 *
 */
public class ActivityExecutionPopulator implements IUML2TraceElementPopulator {
	...
	public void populate(Object umlTraceElement, Object fumlTraceElement,
		...
		if(!(umlTraceElement instanceof ActivityExecution) || !(fumlTraceElement instanceof org.modelexecution.fumldebug.core.trace.tracemodel.ActivityExecution)) {
			return;
		}

		ActivityExecution umlActivityExecution = (ActivityExecution) umlTraceElement;
