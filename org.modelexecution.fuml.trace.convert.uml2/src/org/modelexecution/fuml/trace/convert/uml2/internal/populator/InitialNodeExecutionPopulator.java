 ...
 *
 */
public class InitialNodeExecutionPopulator implements IUML2TraceElementPopulator {
	...
	public void populate(Object umlTraceElement, Object fumlTraceElement,
		...
		if(!(umlTraceElement instanceof InitialNodeExecution) || !(fumlTraceElement instanceof org.modelexecution.fumldebug.core.trace.tracemodel.InitialNodeExecution)) {
			return;
		}

		InitialNodeExecution umlInitialNodeExecution = (InitialNodeExecution) umlTraceElement;
		org.modelexecution.fumldebug.core.trace.tracemodel.InitialNodeExecution fumlInitialNodeExecution = (org.modelexecution.fumldebug.core.trace.tracemodel.InitialNodeExecution) fumlTraceElement;
		
		umlInitialNodeExecution.setOutgoingControl((ControlTokenInstance)result.getOutputUMLTraceElement(fumlInitialNodeExecution.getOutgoingControl()));
