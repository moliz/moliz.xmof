 ...
 *
 */
public class ParameterValuePopulator implements IUML2TraceElementPopulator {
	...
	public void populate(Object umlTraceElement, Object fumlTraceElement,
		...
		if(!(umlTraceElement instanceof ParameterValue) || !(fumlTraceElement instanceof org.modelexecution.fumldebug.core.trace.tracemodel.ParameterValue)) {
			return;
		}

		ParameterValue umlParameterValue = (ParameterValue) umlTraceElement;
		org.modelexecution.fumldebug.core.trace.tracemodel.ParameterValue fumlParameterValue = (org.modelexecution.fumldebug.core.trace.tracemodel.ParameterValue) fumlTraceElement;
		
		umlParameterValue.setValueSnapshot((ValueSnapshot)result.getOutputUMLTraceElement(fumlParameterValue.getValueSnapshot()));
	}
