 ...
 *
 */
public class IntegerValuePopulator implements IUML2TraceElementPopulator {
	...
	public void populate(Object umlTraceElement, Object fumlTraceElement,
		...
		if(!(umlTraceElement instanceof IntegerValue) || !(fumlTraceElement instanceof fUML.Semantics.Classes.Kernel.IntegerValue)) {
			return;
		}

		IntegerValue umlIntegerValue = (IntegerValue) umlTraceElement;
		fUML.Semantics.Classes.Kernel.IntegerValue fumlIntegerValue = (fUML.Semantics.Classes.Kernel.IntegerValue) fumlTraceElement;
		
		umlIntegerValue.setValue(fumlIntegerValue.value);
