 ...
 *
 */
public class OutputParameterValuePopulator implements IUML2TraceElementPopulator {
	...
	public void populate(Object umlTraceElement, Object fumlTraceElement,
		...
		if(!(umlTraceElement instanceof OutputParameterValue) || !(fumlTraceElement instanceof org.modelexecution.fumldebug.core.trace.tracemodel.OutputParameterValue)) {
			return;
		}

		OutputParameterValue umlOutputParameterValue = (OutputParameterValue) umlTraceElement;
		org.modelexecution.fumldebug.core.trace.tracemodel.OutputParameterValue fumlOutputParameterValue = (org.modelexecution.fumldebug.core.trace.tracemodel.OutputParameterValue) fumlTraceElement;
		
		umlOutputParameterValue.setParameterOutputObjectToken((ObjectTokenInstance)result.getOutputUMLTraceElement(fumlOutputParameterValue.getParameterOutputObjectToken()));
	}
