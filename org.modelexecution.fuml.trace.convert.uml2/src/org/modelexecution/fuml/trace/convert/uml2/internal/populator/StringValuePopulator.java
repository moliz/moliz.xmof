 ...
 *
 */
public class StringValuePopulator implements IUML2TraceElementPopulator {
	...
	public void populate(Object umlTraceElement, Object fumlTraceElement,
		...
		if(!(umlTraceElement instanceof StringValue) || !(fumlTraceElement instanceof fUML.Semantics.Classes.Kernel.StringValue)) {
			return;
		}

		StringValue umlStringValue = (StringValue) umlTraceElement;
		fUML.Semantics.Classes.Kernel.StringValue fumlStringValue = (fUML.Semantics.Classes.Kernel.StringValue) fumlTraceElement;
		
		umlStringValue.setValue(fumlStringValue.value);
