 ...
 *
 */
public class EnumerationValuePopulator implements IUML2TraceElementPopulator {
	...
	public void populate(Object umlTraceElement, Object fumlTraceElement,
		...
		if(!(umlTraceElement instanceof EnumerationValue) || !(fumlTraceElement instanceof fUML.Semantics.Classes.Kernel.EnumerationValue)) {
			return;
		}

		EnumerationValue umlEnumerationValue = (EnumerationValue) umlTraceElement;
		fUML.Semantics.Classes.Kernel.EnumerationValue fumlEnumerationValue = (fUML.Semantics.Classes.Kernel.EnumerationValue) fumlTraceElement;
