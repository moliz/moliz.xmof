 ...
 *
 */
public class ObjectTokenInstancePopulator implements IUML2TraceElementPopulator {
	...
	public void populate(Object umlTraceElement, Object fumlTraceElement,
		...
		if(!(umlTraceElement instanceof ObjectTokenInstance) || !(fumlTraceElement instanceof org.modelexecution.fumldebug.core.trace.tracemodel.ObjectTokenInstance)) {
			return;
		}
