 ...
 *
 */
public class InputValuePopulator implements IUML2TraceElementPopulator {
	...
	public void populate(Object umlTraceElement, Object fumlTraceElement,
		...
		if(!(umlTraceElement instanceof InputValue) || !(fumlTraceElement instanceof org.modelexecution.fumldebug.core.trace.tracemodel.InputValue)) {
			return;
		}

		InputValue umlInputValue = (InputValue) umlTraceElement;
		org.modelexecution.fumldebug.core.trace.tracemodel.InputValue fumlInputValue = (org.modelexecution.fumldebug.core.trace.tracemodel.InputValue) fumlTraceElement;
	
		umlInputValue.setInputObjectToken((ObjectTokenInstance)result.getOutputUMLTraceElement(fumlInputValue.getInputObjectToken()));
	}
