...
public class NamedElementPopulator implements IElementPopulator {
	...
	public void populate(fUML.Syntax.Classes.Kernel.Element fumlElement,
		...
		if (fumlElement instanceof fUML.Syntax.Classes.Kernel.NamedElement) {
			// casting
			...
			// simple type values
			fumlNamedElement.name = uml2NamedElement.getName();
			fumlNamedElement.qualifiedName = uml2NamedElement
					.getQualifiedName();

			// enum values
			fumlNamedElement.visibility = castVisibilityKind(uml2NamedElement
					.getVisibility());
	...
	private fUML.Syntax.Classes.Kernel.VisibilityKind castVisibilityKind(
