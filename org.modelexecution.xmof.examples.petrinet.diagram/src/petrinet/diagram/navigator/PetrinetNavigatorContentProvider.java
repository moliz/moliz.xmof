	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(createNavigatorItems(
					selectViewsByType(topViews, NetEditPart.MODEL_ID), file,
					false));
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case TransitionInputEditPart.VISUAL_ID: {
			...
			PetrinetNavigatorGroup target = new PetrinetNavigatorGroup(
					Messages.NavigatorGroupName_TransitionInput_4002_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			PetrinetNavigatorGroup source = new PetrinetNavigatorGroup(
					Messages.NavigatorGroupName_TransitionInput_4002_source,
		...
		case TransitionOutputEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			PetrinetNavigatorGroup target = new PetrinetNavigatorGroup(
					Messages.NavigatorGroupName_TransitionOutput_4001_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			PetrinetNavigatorGroup source = new PetrinetNavigatorGroup(
					Messages.NavigatorGroupName_TransitionOutput_4001_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					PetrinetVisualIDRegistry.getType(PlaceEditPart.VISUAL_ID));
