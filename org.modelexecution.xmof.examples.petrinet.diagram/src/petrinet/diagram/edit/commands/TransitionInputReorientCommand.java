 ...
 * @generated
 */
public class TransitionInputReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public TransitionInputReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return PetrinetBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTransitionInput_4002(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return PetrinetBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTransitionInput_4002(getOldSource(), getNewTarget());
	}
