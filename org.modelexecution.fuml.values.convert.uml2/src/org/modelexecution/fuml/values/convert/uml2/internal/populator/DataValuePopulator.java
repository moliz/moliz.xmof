 ...
 *
 */
public class DataValuePopulator implements IFUMLValuePopulator {
	...
	public void populate(Value umlValue,
		...
		if(!(umlValue instanceof DataValue) || !(fumlValue instanceof fUML.Semantics.Classes.Kernel.DataValue)) {
			return;
		}

		DataValue umlDataValue = (DataValue) umlValue;
		fUML.Semantics.Classes.Kernel.DataValue fumlDataValue = (fUML.Semantics.Classes.Kernel.DataValue) fumlValue;
