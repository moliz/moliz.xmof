 ...
 *
 */
public class StringValuePopulator implements IFUMLValuePopulator {
	...
	public void populate(Value umlValue,
		...
		if(!(umlValue instanceof StringValue) || !(fumlValue instanceof fUML.Semantics.Classes.Kernel.StringValue)) {
			return;
		}

		StringValue umlStringValue = (StringValue) umlValue;
		fUML.Semantics.Classes.Kernel.StringValue fumlStringValue = (fUML.Semantics.Classes.Kernel.StringValue) fumlValue;
