 ...
 *
 */
public class LinkPopulator implements IFUMLValuePopulator {
	...
	public void populate(Value umlValue,
		...
		if(!(umlValue instanceof Link) || !(fumlValue instanceof fUML.Semantics.Classes.Kernel.Link)) {
			return;
		}

		Link umlLink = (Link) umlValue;
		fUML.Semantics.Classes.Kernel.Link fumlLink = (fUML.Semantics.Classes.Kernel.Link) fumlValue;
