 ...
 *
 */
public class IntegerValuePopulator implements IFUMLValuePopulator {
	...
	public void populate(Value umlValue,
		...
		if(!(umlValue instanceof IntegerValue) || !(fumlValue instanceof fUML.Semantics.Classes.Kernel.IntegerValue)) {
			return;
		}

		IntegerValue umlIntegerValue = (IntegerValue) umlValue;
		fUML.Semantics.Classes.Kernel.IntegerValue fumlIntegerValue = (fUML.Semantics.Classes.Kernel.IntegerValue) fumlValue;
