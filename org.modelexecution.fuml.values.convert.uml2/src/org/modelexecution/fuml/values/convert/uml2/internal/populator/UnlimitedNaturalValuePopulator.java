 ...
 *
 */
public class UnlimitedNaturalValuePopulator implements IFUMLValuePopulator {
	...
	public void populate(Value umlValue,
		...
		if(!(umlValue instanceof UnlimitedNaturalValue) || !(fumlValue instanceof fUML.Semantics.Classes.Kernel.UnlimitedNaturalValue)) {
			return;
		}

		UnlimitedNaturalValue umlUnlimitedNaturalValue = (UnlimitedNaturalValue) umlValue;
		fUML.Semantics.Classes.Kernel.UnlimitedNaturalValue fumlUnlimitedNaturalValue = (fUML.Semantics.Classes.Kernel.UnlimitedNaturalValue) fumlValue;
		
		umlUnlimitedNaturalValue.setValue(fumlUnlimitedNaturalValue.value.naturalValue);
