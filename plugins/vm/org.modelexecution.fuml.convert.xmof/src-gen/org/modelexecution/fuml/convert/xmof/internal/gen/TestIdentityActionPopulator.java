...
public class TestIdentityActionPopulator implements IElementPopulator {
	...
	public void populate(fUML.Syntax.Classes.Kernel.Element fumlElement,
		...
		if (!(element instanceof org.modelexecution.xmof.Syntax.Actions.IntermediateActions.TestIdentityAction) ||
		...
		org.modelexecution.xmof.Syntax.Actions.IntermediateActions.TestIdentityAction xmofElement = (org.modelexecution.xmof.Syntax.Actions.IntermediateActions.TestIdentityAction) element;
		
		fumlNamedElement.second = (fUML.Syntax.Actions.BasicActions.InputPin) result
							.getFUMLElement(xmofElement.getSecond());
		...
		fumlNamedElement.first = (fUML.Syntax.Actions.BasicActions.InputPin) result
							.getFUMLElement(xmofElement.getFirst());
