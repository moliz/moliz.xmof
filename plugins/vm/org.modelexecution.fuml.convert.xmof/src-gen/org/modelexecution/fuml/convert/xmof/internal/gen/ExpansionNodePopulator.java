...
public class ExpansionNodePopulator implements IElementPopulator {
	...
	public void populate(fUML.Syntax.Classes.Kernel.Element fumlElement,
		...
		if (!(element instanceof org.modelexecution.xmof.Syntax.Activities.ExtraStructuredActivities.ExpansionNode) ||
		...
		org.modelexecution.xmof.Syntax.Activities.ExtraStructuredActivities.ExpansionNode xmofElement = (org.modelexecution.xmof.Syntax.Activities.ExtraStructuredActivities.ExpansionNode) element;
		
		fumlNamedElement.regionAsOutput = (fUML.Syntax.Activities.ExtraStructuredActivities.ExpansionRegion) result
							.getFUMLElement(xmofElement.getRegionAsOutput());
		fumlNamedElement.regionAsInput = (fUML.Syntax.Activities.ExtraStructuredActivities.ExpansionRegion) result
							.getFUMLElement(xmofElement.getRegionAsInput());
