 ...
 * <ul>
 *   <li>{@link org.modelexecution.xmof.Syntax.Actions.CompleteActions.impl.ReclassifyObjectActionImpl#isReplaceAll <em>Replace All</em>}</li>
...
public class ReclassifyObjectActionImpl extends ActionImpl implements ReclassifyObjectAction {
	 ...
	 * @ordered
	 */
	protected EList<EClassifier> oldClassifier;
	 ...
	 * @ordered
	 */
	protected EList<EClassifier> newClassifier;
	 ...
	 * @generated
	 */
	public EList<EClassifier> getOldClassifier() {
		if (oldClassifier == null) {
			oldClassifier = new EObjectResolvingEList<EClassifier>(EClassifier.class, this, CompleteActionsPackage.RECLASSIFY_OBJECT_ACTION__OLD_CLASSIFIER);
		}
	 ...
	 * @generated
	 */
	public EList<EClassifier> getNewClassifier() {
		if (newClassifier == null) {
			newClassifier = new EObjectResolvingEList<EClassifier>(EClassifier.class, this, CompleteActionsPackage.RECLASSIFY_OBJECT_ACTION__NEW_CLASSIFIER);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case CompleteActionsPackage.RECLASSIFY_OBJECT_ACTION__OLD_CLASSIFIER:
				...
				getOldClassifier().addAll((Collection<? extends EClassifier>)newValue);
				return;
			case CompleteActionsPackage.RECLASSIFY_OBJECT_ACTION__OBJECT:
			...
			case CompleteActionsPackage.RECLASSIFY_OBJECT_ACTION__NEW_CLASSIFIER:
				...
				getNewClassifier().addAll((Collection<? extends EClassifier>)newValue);
				return;
		}
