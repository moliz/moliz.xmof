...
public class PrimitiveTypeItemProvider
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PrimitiveType.class)) {
			case KernelPackage.PRIMITIVE_TYPE__NAME:
			case KernelPackage.PRIMITIVE_TYPE__INSTANCE_CLASS_NAME:
			case KernelPackage.PRIMITIVE_TYPE__INSTANCE_CLASS:
			case KernelPackage.PRIMITIVE_TYPE__DEFAULT_VALUE:
			case KernelPackage.PRIMITIVE_TYPE__INSTANCE_TYPE_NAME:
			case KernelPackage.PRIMITIVE_TYPE__SERIALIZABLE:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case KernelPackage.PRIMITIVE_TYPE__EANNOTATIONS:
			case KernelPackage.PRIMITIVE_TYPE__ETYPE_PARAMETERS:
