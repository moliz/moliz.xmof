...
public class CreateRemoveStructuralFeatureValueActionFeature extends
		CreateActionFeature {

	protected final static String ACTION_TYPE_NAME = "Remove Structural Feature Value Action";

	public CreateRemoveStructuralFeatureValueActionFeature(IFeatureProvider fp) {
