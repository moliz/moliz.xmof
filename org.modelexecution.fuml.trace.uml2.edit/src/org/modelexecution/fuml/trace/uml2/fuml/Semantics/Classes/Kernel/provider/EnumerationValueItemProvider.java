...
/**
 * This is the item provider adapter for a {@link org.modelexecution.fuml.trace.uml2.fuml.Semantics.Classes.Kernel.EnumerationValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumerationValueItemProvider extends ValueItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_EnumerationValue_literal_feature", "_UI_EnumerationValue_type"),
				 KernelPackage.Literals.ENUMERATION_VALUE__LITERAL,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EnumerationValue_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EnumerationValue_type_feature", "_UI_EnumerationValue_type"),
				 KernelPackage.Literals.ENUMERATION_VALUE__TYPE,
				 true,
				 false,
				 true,
				 null,
