...
/**
 * This is the item provider adapter for a {@link org.modelexecution.fuml.trace.uml2.fuml.Semantics.Classes.Kernel.IntegerValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntegerValueItemProvider extends PrimitiveValueItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 KernelPackage.Literals.INTEGER_VALUE__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		String valueId = getValueId(integerValue);
		String valueString = ValueTextUtil.getValueString(integerValue);
		if(!valueId.equals(""))
			valueId = " " + valueId;
		return getString("_UI_IntegerValue_type") + valueId + " " + valueString;
	}
