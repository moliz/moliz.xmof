...
/**
 * This is the item provider adapter for a {@link org.modelexecution.fuml.trace.uml2.tracemodel.Output} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OutputItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Output_outputPin_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Output_outputPin_feature", "_UI_Output_type"),
				 TracemodelPackage.Literals.OUTPUT__OUTPUT_PIN,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TracemodelPackage.Literals.OUTPUT__OUTPUT_VALUES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TracemodelPackage.Literals.OUTPUT__OUTPUT_VALUES,
				 TracemodelFactory.eINSTANCE.createOutputValue()));
	}
