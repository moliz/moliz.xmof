...
public class BasicBehaviorsPackageImpl extends EPackageImpl implements BasicBehaviorsPackage {
	 ...
	 * @generated
	 */
	private EClass parameterValueDefinitionEClass = null;
	 ...
	 * @see org.modelexecution.xmof.Semantics.CommonBehaviors.BasicBehaviors.BasicBehaviorsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static BasicBehaviorsPackage init() {
		...
		org.modelexecution.xmof.Syntax.CommonBehaviors.BasicBehaviors.impl.BasicBehaviorsPackageImpl theBasicBehaviorsPackage_1 = (org.modelexecution.xmof.Syntax.CommonBehaviors.BasicBehaviors.impl.BasicBehaviorsPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(org.modelexecution.xmof.Syntax.CommonBehaviors.BasicBehaviors.BasicBehaviorsPackage.eNS_URI) instanceof org.modelexecution.xmof.Syntax.CommonBehaviors.BasicBehaviors.impl.BasicBehaviorsPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(org.modelexecution.xmof.Syntax.CommonBehaviors.BasicBehaviors.BasicBehaviorsPackage.eNS_URI) : org.modelexecution.xmof.Syntax.CommonBehaviors.BasicBehaviors.BasicBehaviorsPackage.eINSTANCE);
	 ...
	 * @generated
	 */
	public EClass getParameterValueDefinition() {
		return parameterValueDefinitionEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getParameterValueDefinition_ParameterValues() {
		return (EReference)parameterValueDefinitionEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		parameterValueDefinitionEClass = createEClass(PARAMETER_VALUE_DEFINITION);
		createEReference(parameterValueDefinitionEClass, PARAMETER_VALUE_DEFINITION__PARAMETER_VALUES);
	}
	...
	public void initializePackageContents() {
		...
		org.modelexecution.xmof.Semantics.Classes.Kernel.KernelPackage theKernelPackage_1 = (org.modelexecution.xmof.Semantics.Classes.Kernel.KernelPackage)EPackage.Registry.INSTANCE.getEPackage(org.modelexecution.xmof.Semantics.Classes.Kernel.KernelPackage.eNS_URI);
		...
		initEReference(getParameterValue_Parameter(), theKernelPackage.getDirectedParameter(), null, "parameter", null, 1, 1, ParameterValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEClass(parameterValueDefinitionEClass, ParameterValueDefinition.class, "ParameterValueDefinition", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getParameterValueDefinition_ParameterValues(), this.getParameterValue(), null, "parameterValues", null, 0, -1, ParameterValueDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
