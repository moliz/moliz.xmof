...
public class BasicBehaviorsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case BasicBehaviorsPackage.PARAMETER_VALUE_DEFINITION: {
				ParameterValueDefinition parameterValueDefinition = (ParameterValueDefinition)theEObject;
				T result = caseParameterValueDefinition(parameterValueDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Parameter Value Definition</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Parameter Value Definition</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseParameterValueDefinition(ParameterValueDefinition object) {
		return null;
	}
