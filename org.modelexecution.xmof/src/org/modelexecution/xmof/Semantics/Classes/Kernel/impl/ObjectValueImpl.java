 ...
 * <ul>
 *   <li>{@link org.modelexecution.xmof.Semantics.Classes.Kernel.impl.ObjectValueImpl#getEObject <em>EObject</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ObjectValueImpl extends ValueImpl implements ObjectValue {
	...
	protected EClass eStaticClass() {
		return KernelPackage.Literals.OBJECT_VALUE;
	}
		...
		if (eObject != null && eObject.eIsProxy()) {
			...
			if (eObject != oldEObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, KernelPackage.OBJECT_VALUE__EOBJECT, oldEObject, eObject));
			}
		}
		return eObject;
	}
	...
	public void setEObject(EObject newEObject) {
		...
		eObject = newEObject;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KernelPackage.OBJECT_VALUE__EOBJECT, oldEObject, eObject));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KernelPackage.OBJECT_VALUE__EOBJECT:
