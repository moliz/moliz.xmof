	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CommunicationsPackage.SIGNAL: {
				...
				if (result == null) result = caseENamedElement(signal);
			...
			case CommunicationsPackage.SIGNAL_EVENT: {
				...
				if (result == null) result = caseENamedElement(signalEvent);
			...
			case CommunicationsPackage.MESSAGE_EVENT: {
				...
				if (result == null) result = caseENamedElement(messageEvent);
			...
			case CommunicationsPackage.RECEPTION: {
				...
				if (result == null) result = caseBehavioredEOperation(reception);
				if (result == null) result = caseEOperation(reception);
				if (result == null) result = caseETypedElement(reception);
				if (result == null) result = caseENamedElement(reception);
