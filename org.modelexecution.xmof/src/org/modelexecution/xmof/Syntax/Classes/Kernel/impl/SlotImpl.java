 ...
 * <ul>
 *   <li>{@link org.modelexecution.xmof.Syntax.Classes.Kernel.impl.SlotImpl#getDefiningFeature <em>Defining Feature</em>}</li>
 *   <li>{@link org.modelexecution.xmof.Syntax.Classes.Kernel.impl.SlotImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.modelexecution.xmof.Syntax.Classes.Kernel.impl.SlotImpl#getOwningInstance <em>Owning Instance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SlotImpl extends EModelElementImpl implements Slot {
	/**
	 ...
	 * @ordered
	 */
	protected EStructuralFeature definingFeature;
	 ...
	 * @generated
	 */
	public EStructuralFeature basicGetDefiningFeature() {
		return definingFeature;
	}
	 ...
	 * @generated
	 */
	public void setDefiningFeature(EStructuralFeature newDefiningFeature) {
		EStructuralFeature oldDefiningFeature = definingFeature;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case KernelPackage.SLOT__DEFINING_FEATURE:
				setDefiningFeature((EStructuralFeature)newValue);
				return;
			case KernelPackage.SLOT__VALUE:
				getValue().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case KernelPackage.SLOT__DEFINING_FEATURE:
				setDefiningFeature((EStructuralFeature)null);
				return;
			case KernelPackage.SLOT__VALUE:
				getValue().clear();
				return;
