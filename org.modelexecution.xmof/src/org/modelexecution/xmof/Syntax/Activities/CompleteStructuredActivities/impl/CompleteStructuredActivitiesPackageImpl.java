...
public class CompleteStructuredActivitiesPackageImpl extends EPackageImpl implements CompleteStructuredActivitiesPackage {
	 ...
	 * @see org.modelexecution.xmof.Syntax.Activities.CompleteStructuredActivities.CompleteStructuredActivitiesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		clauseEClass.getESuperTypes().add(ecorePackage.getEModelElement());
		...
		initEAttribute(getLoopNode_IsTestedFirst(), ecorePackage.getEJavaObject(), "isTestedFirst", null, 1, 1, LoopNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getConditionalNode_IsDeterminate(), ecorePackage.getEJavaObject(), "isDeterminate", null, 1, 1, ConditionalNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getConditionalNode_IsAssured(), ecorePackage.getEJavaObject(), "isAssured", null, 1, 1, ConditionalNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getStructuredActivityNode_MustIsolate(), ecorePackage.getEJavaObject(), "mustIsolate", null, 1, 1, StructuredActivityNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
