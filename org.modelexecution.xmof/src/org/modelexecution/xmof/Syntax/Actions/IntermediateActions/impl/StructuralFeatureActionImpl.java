 ...
 * <ul>
 *   <li>{@link org.modelexecution.xmof.Syntax.Actions.IntermediateActions.impl.StructuralFeatureActionImpl#getStructuralFeature <em>Structural Feature</em>}</li>
 *   <li>{@link org.modelexecution.xmof.Syntax.Actions.IntermediateActions.impl.StructuralFeatureActionImpl#getObject <em>Object</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class StructuralFeatureActionImpl extends ActionImpl implements StructuralFeatureAction {
	...
	protected List<OutputPin> getAsList(OutputPin pin) {
		UniqueEList<OutputPin> uniqueEList = new UniqueEList<OutputPin>(
				pin != null ? 1 : 0);
		if (pin != null)
			uniqueEList.add(pin);
		return uniqueEList;
	...
	protected List<InputPin> getAsList(InputPin pin) {
		UniqueEList<InputPin> uniqueEList = new UniqueEList<InputPin>(
				pin != null ? 1 : 0);
		if (pin != null)
			uniqueEList.add(pin);
		return uniqueEList;
