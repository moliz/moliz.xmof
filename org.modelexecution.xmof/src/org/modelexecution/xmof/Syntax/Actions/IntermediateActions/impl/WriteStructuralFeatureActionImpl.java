 ...
 * <em><b>Write Structural Feature Action</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link org.modelexecution.xmof.Syntax.Actions.IntermediateActions.impl.WriteStructuralFeatureActionImpl#getValue
 * <em>Value</em>}</li>
 * <li>
 * {@link org.modelexecution.xmof.Syntax.Actions.IntermediateActions.impl.WriteStructuralFeatureActionImpl#getResult
 * <em>Result</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public abstract class WriteStructuralFeatureActionImpl extends
		StructuralFeatureActionImpl implements WriteStructuralFeatureAction {
	/**
	...
	private EList<OutputPin> output;
	...
	public NotificationChain basicSetValue(InputPin newValue,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
					this,
					Notification.SET,
					IntermediateActionsPackage.WRITE_STRUCTURAL_FEATURE_ACTION__VALUE,
					oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
	...
	public NotificationChain basicSetResult(OutputPin newResult,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(
					this,
					Notification.SET,
					IntermediateActionsPackage.WRITE_STRUCTURAL_FEATURE_ACTION__RESULT,
					oldResult, newResult);
			if (msgs == null)
				msgs = notification;
			else
	...
	// TODO create a field that is a list which contains the result; result should be updated when basicSetResult is called
	@Override
	public EList<OutputPin> getOutput() {
		if (output == null) {
			output = new DelegatingEcoreEList.UnmodifiableEList<OutputPin>(
					this, BasicActionsPackage.eINSTANCE.getAction_Output(),
					super.getAsList(getResult()));
		}
		return output;
	}
