 ...
 * <ul>
 *   <li>{@link org.modelexecution.xmof.Syntax.Actions.IntermediateActions.impl.LinkEndDataImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.modelexecution.xmof.Syntax.Actions.IntermediateActions.impl.LinkEndDataImpl#getEnd <em>End</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LinkEndDataImpl extends EModelElementImpl implements LinkEndData {
	/**
	 ...
	 * @generated
	 */
	public EReference getEnd() {
		if (end != null && end.eIsProxy()) {
			InternalEObject oldEnd = (InternalEObject)end;
			end = (EReference)eResolveProxy(oldEnd);
			if (end != oldEnd) {
				if (eNotificationRequired())
	 ...
	 * @generated
	 */
	public void setEnd(EReference newEnd) {
		EReference oldEnd = end;
		end = newEnd;
		if (eNotificationRequired())
