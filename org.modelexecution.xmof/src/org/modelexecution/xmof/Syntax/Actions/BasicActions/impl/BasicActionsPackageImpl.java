...
public class BasicActionsPackageImpl extends EPackageImpl implements BasicActionsPackage {
	 ...
	 * @see org.modelexecution.xmof.Syntax.Actions.BasicActions.BasicActionsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		pinEClass.getESuperTypes().add(ecorePackage.getETypedElement());
		...
		initEAttribute(getAction_IsLocallyReentrant(), ecorePackage.getEJavaObject(), "isLocallyReentrant", null, 1, 1, Action.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getCallAction_IsSynchronous(), ecorePackage.getEJavaObject(), "isSynchronous", null, 1, 1, CallAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getCallOperationAction_Operation(), theKernelPackage.getBehavioredEOperation(), null, "operation", null, 1, 1, CallOperationAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
