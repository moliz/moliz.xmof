 ...
 * @generated
 */
public class Petrinet2VisualIDRegistry {

	/**
	 * @generated
	 */
	private static final String DEBUG_KEY = "org.modelexecution.xmof.examples.petrinet2.diagram/debug/visualID"; //$NON-NLS-1$
	...
	public static int getVisualID(View view) {
		...
		return petrinet2.diagram.part.Petrinet2VisualIDRegistry
	...
	public static int getDiagramVisualID(EObject domainElement) {
		...
		if (Petrinet2Package.eINSTANCE.getNet().isSuperTypeOf(
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = petrinet2.diagram.part.Petrinet2VisualIDRegistry
		...
		if (NetEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = petrinet2.diagram.part.Petrinet2VisualIDRegistry
		...
		case NetEditPart.VISUAL_ID:
			if (Petrinet2Package.eINSTANCE.getTransition().isSuperTypeOf(
					domainElement.eClass())) {
				return TransitionEditPart.VISUAL_ID;
			}
			if (Petrinet2Package.eINSTANCE.getPlace().isSuperTypeOf(
					domainElement.eClass())) {
