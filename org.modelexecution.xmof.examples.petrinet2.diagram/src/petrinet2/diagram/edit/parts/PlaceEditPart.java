package petrinet2.diagram.edit.parts;
...
import petrinet2.diagram.edit.policies.PlaceItemSemanticEditPolicy;
...
public class PlaceEditPart extends ShapeNodeEditPart {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(Petrinet2VisualIDRegistry
	...
	public List<IElementType> getMARelTypesOnTarget() {
		...
		types.add(Petrinet2ElementTypes.TransitionOutput_4001);
		types.add(Petrinet2ElementTypes.TransitionInput_4002);
		return types;
	}
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		...
		if (relationshipType == Petrinet2ElementTypes.TransitionOutput_4001) {
			types.add(Petrinet2ElementTypes.Transition_2001);
		} else if (relationshipType == Petrinet2ElementTypes.TransitionInput_4002) {
			types.add(Petrinet2ElementTypes.Transition_2001);
		}
		return types;
	}
