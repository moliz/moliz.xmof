...
import petrinet2.diagram.edit.policies.Petrinet2TextSelectionEditPolicy;
...
public class TransitionNameEditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new Petrinet2TextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new NetEditPart.NodeLabelDragPolicy());
	}
	...
	protected Image getLabelIcon() {
		...
		return Petrinet2ElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = Petrinet2ParserProvider
					.getParser(
							Petrinet2ElementTypes.Transition_2001,
							getParserElement(),
							Petrinet2VisualIDRegistry
									.getType(petrinet2.diagram.edit.parts.TransitionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					Petrinet2EditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
