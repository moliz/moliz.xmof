...
import petrinet2.diagram.parsers.MessageFormatParser;
import petrinet2.diagram.part.Petrinet2VisualIDRegistry;

/**
 * @generated
 */
public class Petrinet2ParserProvider extends AbstractProvider implements
		IParserProvider {
	...
	private IParser getTransitionName_5001Parser() {
		if (transitionName_5001Parser == null) {
			EAttribute[] features = new EAttribute[] { Petrinet2Package.eINSTANCE
					.getTransition_Name() };
	...
	public IParser getParser(IAdaptable hint) {
		...
		if (vid != null) {
			return getParser(Petrinet2VisualIDRegistry.getVisualID(vid));
		}
		View view = (View) hint.getAdapter(View.class);
		if (view != null) {
			return getParser(Petrinet2VisualIDRegistry.getVisualID(view));
		}
		return null;
	}
	...
	public boolean provides(IOperation operation) {
		if (operation instanceof GetParserOperation) {
			...
			if (Petrinet2ElementTypes.getElement(hint) == null) {
				return false;
			}
