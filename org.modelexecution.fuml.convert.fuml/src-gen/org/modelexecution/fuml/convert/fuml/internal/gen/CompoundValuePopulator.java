...
public class CompoundValuePopulator implements IElementPopulator {
	...
	public void populate(Object fumlElement,
		...
		for (org.modelexecution.fuml.Semantics.Classes.Kernel.FeatureValue value : fumlNamedElement_.getFeatureValues()) {
					fumlNamedElement.featureValues.add((fUML.Semantics.Classes.Kernel.FeatureValue) result.getFUMLElement(value));
		}
