...
public class ReferencePopulator implements IElementPopulator {
	...
	public void populate(Object fumlElement,
		...
		fumlNamedElement.referent = (fUML.Semantics.Classes.Kernel.Object_) result
							.getFUMLElement(fumlNamedElement_.getReferent());
	}
