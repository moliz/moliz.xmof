...
public class FeatureValuePopulator implements IElementPopulator {
	...
	public void populate(Object fumlElement,
		...
		fumlNamedElement.feature = (fUML.Syntax.Classes.Kernel.StructuralFeature) result
							.getFUMLElement(fumlNamedElement_.getFeature());
		
		for (org.modelexecution.fuml.Semantics.Classes.Kernel.Value value : fumlNamedElement_.getValues()) {
					fumlNamedElement.values.add((fUML.Semantics.Classes.Kernel.Value) result.getFUMLElement(value));
		}
